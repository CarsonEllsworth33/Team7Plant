...
import com.google.samples.apps.sunflower.data.MyPlant
import com.google.samples.apps.sunflower.data.MyPlantRepository

/**
 * The ViewModel for [PlantListFragment].
 */
class MyPlantListViewModel @ViewModelInject internal constructor(
        plantRepository: MyPlantRepository,
        @Assisted private val savedStateHandle: SavedStateHandle
) : ViewModel() {

    val plants: LiveData<List<MyPlant>> = getSavedGrowZoneNumber().switchMap {
        //if (it == NO_GROW_ZONE) {
